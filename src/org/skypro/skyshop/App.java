...
public class App {
    ...
    private static List<Searchable> products = Arrays.asList(new SimpleProduct("Простой продукт", 10), new DiscountProduct("Скидочный продукт", 20, 10), new SimpleProduct("Тестовый товар", 15));
